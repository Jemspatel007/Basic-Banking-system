...
<body>
    <nav class="navbar" style="background-color: #464659">
    ...
    <div>
        <h1 class="noselect" style="cursor: pointer;">The Spark Bank</h1>
    </div>
    <section class="main" id="home">
        <div class="content">
            <h1>Transfer money easily</h1>
            <p>This bank  management system is very simple where we can easily Transfer Money to our family and friends. We can also view the transction history and balance in our account. So enjoy This Banking System Website!</p>
            <button class="btn" id="customers" style="background-color: #464659">Our Customers</button>
        </div>
        <div class="image">

        </div>
    </section>
    <section id="services" style="background-color: #464659">
        <h3>Our Services</h3>
        <div class="card">
    ...
    <footer>
        <div class="footer">© 2021. Made by Jems Patel <br>
