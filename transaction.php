<?php
      ...
      $username="epiz_29466785";
      $password="25x32zpW83bg";
      $db="epiz_29466785_tsfbank";
...
<body style="background-color:#ecedf9">
    <nav class="navbar navbar-customer" style="background-color: #464659">
    ...
    <div class="mainSection" style="background-color: #464659">
        ...
        <button type="submit" class="btn" style="background-color: #464659"> Transfer</button>
